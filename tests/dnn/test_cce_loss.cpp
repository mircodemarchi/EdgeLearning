...
private:
    void test_layer() {
        EDGE_LEARNING_TEST_EQUAL(CategoricalCrossEntropyLossLayer::TYPE, "CCELoss");
        EDGE_LEARNING_TEST_EXECUTE(
                auto l1 = CategoricalCrossEntropyLossLayer("cce_loss_layer_test"));
        EDGE_LEARNING_TEST_TRY(
                auto l2 = CategoricalCrossEntropyLossLayer("cce_loss_layer_test"));
        std::vector<NumType> v_empty;
        std::vector<NumType> v(std::size_t(10));
        auto l = CategoricalCrossEntropyLossLayer("cce_loss_layer_test");
        EDGE_LEARNING_TEST_EQUAL(l.TYPE, "CCELoss");
        EDGE_LEARNING_TEST_EQUAL(l.type(), "CCELoss");
        EDGE_LEARNING_TEST_TRY(l.init());
        EDGE_LEARNING_TEST_FAIL(l.training_forward(v_empty));
        EDGE_LEARNING_TEST_THROWS(l.training_forward(v_empty), std::runtime_error);
        ...
        EDGE_LEARNING_TEST_EXECUTE(CategoricalCrossEntropyLossLayer l1_copy{l});
        EDGE_LEARNING_TEST_TRY(CategoricalCrossEntropyLossLayer l2_copy{l});
        CategoricalCrossEntropyLossLayer l_copy{l};
        EDGE_LEARNING_TEST_TRY(l_copy.init());
        EDGE_LEARNING_TEST_FAIL(l_copy.training_forward(v_empty));
        EDGE_LEARNING_TEST_THROWS(l_copy.training_forward(v_empty), std::runtime_error);
        ...
        EDGE_LEARNING_TEST_EXECUTE(CategoricalCrossEntropyLossLayer l_assign; l_assign = l);
        EDGE_LEARNING_TEST_TRY(CategoricalCrossEntropyLossLayer l_assign; l_assign = l);
        CategoricalCrossEntropyLossLayer l_assign; l_assign = l;
        ...
        EDGE_LEARNING_TEST_EXECUTE(auto l1_noname = CategoricalCrossEntropyLossLayer());
        EDGE_LEARNING_TEST_TRY(auto l2_noname = CategoricalCrossEntropyLossLayer());
        auto l_noname = CategoricalCrossEntropyLossLayer();
    ...
    void test_loss_layer() {
        ...
        EDGE_LEARNING_TEST_TRY(
                auto l2 = CategoricalCrossEntropyLossLayer("cce_loss_layer_test",
                                       0, 0));
        auto l = CategoricalCrossEntropyLossLayer(
                              "cce_loss_layer_test",
        ...
        CategoricalCrossEntropyLossLayer l_shape_copy{l};
        ...
        EDGE_LEARNING_TEST_THROWS(l_shape_copy.last_output(),
                                  std::runtime_error);
        CategoricalCrossEntropyLossLayer l_shape_assign; l_shape_assign = l;
    ...
    void test_score() {
        auto l = CategoricalCrossEntropyLossLayer("cce_loss_layer_test", 1);
    ...
    void test_cce_loss_layer() {
        ...
        input_size = 2;
        auto l_binary = CategoricalCrossEntropyLossLayer("cce_loss_layer_test", input_size);
        ...
        EDGE_LEARNING_TEST_TRY(l_binary.training_forward(v3));
    ...
    void test_stream()
    {
        auto l = CategoricalCrossEntropyLossLayer("cce_loss_layer_test", 2);
        ...
        l = CategoricalCrossEntropyLossLayer();
